		...
		<div class="flex flex-col sm:flex-row w-full justify-between items-center sm:pr-28 sm:pl-28">
			<div class="mb-20">
				<div class="mb-32">
					...
					<div>
						<p class="text-xl text-dark-green font-nunito font-normal">OFFLINE AND ONLINE</p>
					</div>
				</div>
				<div>
					<RegisterButton />
			...
			<div>
				...
				class="shadow-lg rounded-2xl"
					width="320"
					height="560"
					src="https://www.youtube.com/embed/cgEFWVQLjB4"
					title="Yoga - 3 months Challenge- 2024"
					frameborder="0"
