	...
	<div class="container px-5 py-24 mx-auto">
		...
		<div class="flex flex-wrap -m-4">
			<div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				...
				>
					<h2 class="text-sm tracking-widest title-font mb-1 font-medium">OFFLINE CLASSES</h2>
					<h1
			...
			<div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				<div
					class="h-full p-6 rounded-lg border-2 border-dark-purple flex flex-col relative overflow-hidden"
				>
					<span
						class="bg-dark-purple text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl"
						>POPULAR</span
					>
                    ...
                    <p class="flex items-center text-gray-600 mb-2">
						...
						</span> <del>9000</del><strong>7500</strong>
					</p>
					<p class="flex items-center text-gray-600 mb-2">
						<span
							class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0"
			...
			<div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				<div
					class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden"
				>
					<h2 class="text-sm tracking-widest title-font mb-1 font-medium">ONLINE CLASSES</h2>
					<h1
						class="text-5xl text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200"
					>
						<span>2500</span>
			...
			<div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				...
				>
                    ...
                    <p class="flex items-center text-gray-600 mb-2">
						...
						</span> <del>7500</del><strong>6000</strong>
					</p>
					<p class="flex items-center text-gray-600 mb-2">
						<span
							class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0"
